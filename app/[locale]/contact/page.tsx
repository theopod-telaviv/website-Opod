...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  ...
  const descriptions = {
    en: 'Contact The O Pod Hotel Tel Aviv. Get in touch for reservations, inquiries, or special requests. Available 24/7.',
    fr: 'Contactez The O Pod Hotel Tel Aviv. Pour des réservations, des questions ou des demandes spéciales. Disponible 24/7.',
    he: 'צרו קשר עם The O Pod Hotel תל אביב. לשאלות, הזמנות או בקשות מיוחדות. זמינים 24/7.',
  };

  const titles = {
    en: "Contact | The O Pod Tel Aviv - 24/7",
    fr: "Contact | The O Pod Tel Aviv - 24/7",
    he: "צור קשר | The O Pod תל אביב - 24/7"
  };
  ...
  return {
    title,
    description,
    keywords: 'contact, The O Pod Hotel, Tel Aviv hotel contact, reservations, customer service',
    openGraph: {
      ...
      url: `https://opodhotel.com/${locale}/contact`,
    },
    twitter: {
      card: 'summary',
      title: `${t('title')} | The O Pod Hotel`,
