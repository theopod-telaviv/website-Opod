export function getOrganizationSchema(locale: string) {
  return {
    ...
    description: {
      he: 'מלון הקפסולות הזול והממוקם הטוב ביותר בתל אביב מול הים החל מ-179₪. מלון קפסולות מודרני צעדים מחוף הים התיכון.',
      en: 'The cheapest and best-located pod hotel in Tel Aviv facing the sea from 179₪. Modern pod hotel steps from the Mediterranean beach.',
      fr: "L'hôtel capsule le moins cher et le mieux placé de Tel Aviv en face de la mer à partir de 179₪. Hôtel capsule moderne à deux pas de la plage.",
    }[locale],
    address: {
      '@type': 'PostalAddress',
